...
export const eslintDisable = `/* eslint-disable indent */
// eslint-disable-next-line indent`;

export const invaderVars = `var gridSize = 8;
var pixelSize = 25;

var drawingArea = document.querySelector('#invader');`;

export const invaderDrawBoard = `var drawBoard = function() {
...
export const invaderRefactStyle = `var setLineStyle = function(line) {
    line.className = 'line';
    line.style.width = (gridSize * pixelSize) + 'px';
};
...
export const invaderStyleStart = `body {
    font-family: sans-serif;
}
...
export const invaderStylePixels = `.pixel--plain {
...
export const invaderClickHandle = `var handlePixelClick = function(event) {
...
export const invaderFillForm = `var fillForm = function() {
...
export const invaderFormCss = `.configuration {
    height: 150px;
    display: flex;
    align-items: center;
    justify-content: center;
...
export const invaderHeightCorrect = `#invader {
    ...
    min-height: calc(100vh - 150px);
    ...
}`;

export const invaderClearBoard = `var clearBoard = function() {
    drawingArea.innerHTML = '';
};`;

export const invaderListener = `var fillForm = function() {
    ...
    form.addEventListener('submit', handleSubmit);
};`;

export const invaderHandleSubmit = `var handleSubmit = function(event) {
    event.preventDefault();
    console.log(event);
...
export const invaderApp = `var app = {
    gridSize: 8,
    pixelSize: 25
};`;

export const invaderInitPart = `var app {
    ...
    init: function() {
...
export const invaderPure = `setLineStyle: function(line) {
    line.className = 'line';
...
export const invaderDraw = `drawBoard: function() {
...
export const invaderReste = `handleSubmit: function(event) {
    event.preventDefault();
    console.log(event);
    var gridInput = event.target.childNodes[0];
    var gridValue = parseInt(gridInput.value, 10);
...
export const invaderInitFull = `init: function() {
    app.drawingArea = document.querySelector('#invader');
    app.form = document.querySelector('.configuration');
    app.drawBoard();
    app.fillForm();
...
export const invaderGenerateInput = `fillForm: function() {
...
export const invaderInputCss = `.configuration input {
    padding: 1em;
    border: 0;
    font-size: 1.2em;
    width: 10em;
...
export const invaderSubmitFull = `handleSubmit: function(event) {
    ...
    app.gridSize = gridValue;
...
export const invaderStyle = `var app {
    ...
    pixelSize: 25,
    style: [
        'plain',
...
export const invaderStyleCss = `.pixel--light {
...
export const invaderPalette1 = `init: function() {
    ...
    app.addPalette();
},
...
...
export const invaderPaletteCss = `.palette {
    position: fixed;
    bottom: 0;
    right: 0;
    display: flex;
...
export const invaderPalette2 = `addPalette: function() {
    app.palette = document.createElement('div');
    app.palette.className = 'palette';
...
export const invaderAddStyle = `addPalette: function() {
    ...
...
export const invaderDataset = `addStyle: function(style) {
    var color = document.createElement('a');
    color.dataset.name = style;
    app.palette.appendChild(color);
}`;

export const invaderAddStyle2 = `addStyle: function(style) {
    var color = document.createElement('a');
...
export const invaderAddStyleCss = `.palette__color {
    margin: .5em;
    border-radius: 50%;
    width: 2em;
    height: 2em;
...
export const invaderDefaultColor = `var app = {
    ...
    chosenColor: 'plain',
    ...
    addStyle: function(style) {
...
export const invaderActive = `.palette__color {
    ...
...
export const invaderColorClick = `handleColorClick: function(event) {
...
export const invaderAddStyle3 = `addStyle: function(style) {
    ...
    color.addEventListener('click', app.handleColorClick);
    ...
}`;

export const invaderPixelClick = `handlePixelClick: function(event) {
    var pixel = event.target;
