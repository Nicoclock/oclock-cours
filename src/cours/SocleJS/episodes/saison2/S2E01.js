            ...
            <div className="Inner">
                ...
                <Card title="Programmation">
                    ...
                    <List>
                        <ListItem title="Qu'est-ce que c'est la programmation ?">
                            ...
                            <Item text="Indiquer à l'ordi grâce à du code comment :" />
                            ...
                            <Item text="... et les langages de programmation, utilisé pour détailler les étapes :" />
                ...
                <Card title="Ca sert à quoi ?">
                    ...
                    <List>
                        ...
                        <Control>
                            ...
                            <BoxItem text="Sondage console affichée : oui/non" />
                        </Control>
                        <ListItem>
                ...
                <Card title="Bases du langage">
                    ...
                    <List>
                        ...
                        <Control>
                            <BoxItem text="Utilisation de console ok ?" />
                            <BoxItem text="Sondage console ok : oui/non" />
                        </Control>
                        <Recap>
                        ...
                        <Control>
                            <BoxItem text="C'est bon pour vous la concaténation ?" />
                            <BoxItem text="Sondage concaténation ok : oui/non" />
                        </Control>
                        <Demo type="repo Syntaxe">
                        ...
                        <Control>
                            <BoxItem text="C'est ok les opérations ?" />
                            <BoxItem text="Sondage opérations ok : oui/non" />
                        </Control>
                        <Demo type="repo Syntaxe">
                            <BoxItem text="Commit / push" />
                        </Demo>
