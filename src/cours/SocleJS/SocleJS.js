...
class SocleJS extends Component {
    ...
    seasons = [
        ...
        {name: "Saison 3", title: "Découverte client/serveur - NodeJS", episodes: ["Node", "Node + HTTP", "Modules (journée ménage)", "Express : routes", "Express: vues", "Atelier", "Middleware", "Response parser", "Atelier solo", "Revisions"]},
        ...
        {name: "Saison 5", title: "Architecture, MVC, POO, ORM", episodes: ["Gestion de projet appliquée", "POO et héritage", "Architecture", "Active Record, 2ème tour", "Sequelize", "Atelier", "Auth et rôles", "Promesses !", "Get Intimate with good Tools", "Atelier solo"]},
