...
class SocleJS extends Component {
    ...
    seasons = [
        ...
        {name: "Saison 5", title: "Architecture, MVC, POO, ORM", episodes: ["Gestion de projet appliquée", "POO et héritage", "Architecture", "Active Record, 2ème tour", "Sequelize", "Atelier", "Auth et rôles", "Promesses !", "Atelier solo"]},
